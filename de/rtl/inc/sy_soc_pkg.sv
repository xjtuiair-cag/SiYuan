...
parameter integer CORE_NUM = 1;
    ...
    parameter GPIO  = 2;
    parameter DMA   = 3;
    parameter ETHERNET = 4;   
    
    parameter SYS_BUS_REGION     = 5;
    ...
    parameter PHRI_BUS_SLAVE_NUM = 5;
    ...
    {UART_START,SPI_START,GPIO_START,DMA_START,ETH_START},
{RESERVED_START,RESERVED_START,ROM_START,PLIC_START,CLINT_START},
{RESERVED_START,RESERVED_START,RESERVED_START,RESERVED_START,DRAM_START}

    };
    
    parameter logic [SYS_BUS_SLAVE_NUM-1:0][SYS_BUS_REGION-1:0][ADDR_WIDTH-1:0]sys_bus_end_addr = {
    {UART_END,SPI_END,GPIO_END,DMA_END,ETH_END},
{RESERVED_END,RESERVED_END,ROM_END,PLIC_END,CLINT_END},
{RESERVED_END,RESERVED_END,RESERVED_END,RESERVED_END,DRAM_END}
...
{1'b0,1'b0,1'b0,1'b0,1'b1}
    ...
    {ETH_START,DMA_START,GPIO_START,SPI_START,UART_START}

    };
    parameter logic [PHRI_BUS_SLAVE_NUM-1:0][PHRI_BUS_REGION-1:0][ADDR_WIDTH-1:0]phri_bus_end_addr = {
    {ETH_END,DMA_END,GPIO_END,SPI_END,UART_END}
