...
//======================================================================================================================
    ...
    logic [ADDR_DEPTH-1:0]      data_ram_addr;      
    logic [DATA_WIDTH-1:0]      data_ram_rdata;            
    logic [DATA_WIDTH-1:0]      data_ram_wdata;            

//======================================================================================================================
// Data array (singel port ram)
//======================================================================================================================
    assign data_ram_addr = data_ram_wen ? data_ram_waddr : data_ram_raddr;
    sp_512x64sd1_wrap data_ram(
        .clk_i          (clk_i),     
        .vld_i          (data_ram_ren || data_ram_wen),     
        .we_i           (data_ram_wen),    
        .addr_i         (data_ram_addr),      
